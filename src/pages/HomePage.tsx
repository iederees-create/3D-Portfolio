...
function HeroReel() {
  ...
  return (
    <motion.div
      ...
      className="relative w-full max-w-[260px] mx-auto rounded-3xl overflow-hidden border border-white/10 shadow-2xl shadow-black/50 cursor-pointer group"
      ...
      <section className="relative overflow-hidden px-6 pt-32 pb-16 sm:pt-36 lg:pb-24">
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1fr_auto] lg:items-center">
          ...
          >
            ...
            {/* Stats panel — below CTAs on left */}
            <motion.div
          ...
          {/* Hero video reel — right column */}
          <div className="hidden lg:flex items-center justify-center self-start mt-8">
            <HeroReel />
          </div>
        </div>
      </section>

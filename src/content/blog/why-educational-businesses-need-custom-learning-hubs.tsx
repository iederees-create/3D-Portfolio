...
/**
 * Article #1: "Why Educational Businesses Need Custom Learning Hubs: The
 * Fluent Path Story". Migrated verbatim from the original single-article
 * BlogSection.tsx (content unchanged — only the surrounding page chrome,
 * meta header, and routing moved into ArticleLayout).
 */
export default function WhyEducationalBusinessesNeedCustomLearningHubsContent() {
  return (
    <div className="prose prose-invert prose-lg max-w-none text-slate-300">
      ...
      <p className="mb-6">
        However, if you require a completely bespoke platform built from the ground up for your specific business logic, you need <a href={`${import.meta.env.BASE_URL}#work`} className="text-white font-semibold hover:text-primary-400 underline decoration-white/30 underline-offset-4">custom web development</a>.
      </p>

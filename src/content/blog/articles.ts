...
import PlumbingWebsiteDesignCapeTownContent from './plumbing-website-design-cape-town';
import RaversusClinicalPortalContent from './raversus-clinical-portal';
...
export const articles: ArticleMeta[] = [
  ...
  },
  {
    ...
    excerpt: 'Personal founder-story blog post introducing Iedrees Francis and NextGenWebs.',
  ...
  },
  {
    ...
    excerpt: 'A comprehensive look at the Amore Nails CT website project built by NextGenWebs — covering the challenge of translating an Instagram-first nail art brand into a premium web presence, portfolio gallery design, service menu architecture, the Cape Town nail salon market, and how a custom TypeScript/Tailwind site creates trust that a booking platform can\'t.',
    datePublished: '2026-07-16',
    dateModified: '2026-07-16',
    author: 'Iedrees Francis',
    category: 'Case Study / Beauty',
    tags: ['Case Study', 'Web Design', 'NextGenWebs'],
  ...
  {
    slug: 'construction-company-website-design-cape-town',
    title: 'Building an Enterprise Construction Company Website That Showcases',
    excerpt: 'Building an Enterprise Construction Company Website That Showcases',
    datePublished: '2026-07-16',
    dateModified: '2026-07-16',
    author: 'Iedrees Francis',
    category: 'Case Study / Service',
  ...
  },
  {
    ...
    title: 'Building a Modular Digital Creator Portfolio Platform With Brand Partnership',
    excerpt: 'Building a Modular Digital Creator Portfolio Platform With Brand Partnership',
    datePublished: '2026-07-16',
    dateModified: '2026-07-16',
    author: 'Iedrees Francis',
    category: 'Case Study / Creative',
    tags: ['Case Study', 'Web Design', 'NextGenWebs'],
  ...
  },
  {
    ...
    title: '"How I Built a Privacy-First Business Intelligence Web App',
    excerpt: 'Blog post: "How I Built a Privacy-First Business Intelligence Web App That Runs Entirely in the Browser"',
    datePublished: '2026-07-16',
    dateModified: '2026-07-16',
    author: 'Iedrees Francis',
    category: 'Case Study',
  ...
  },
  {
    ...
    excerpt: 'Blog post covering the design and development of Summit Painting CT,',
    datePublished: '2026-07-16',
    dateModified: '2026-07-16',
    author: 'Iedrees Francis',
    category: 'Case Study / Service',
  ...
  },
  {
    ...
    excerpt: 'A deep-dive into the Westlake Pest Control HTML/CSS/JS template built by NextGenWebs — covering mobile-first design, WhatsApp CTAs, local SEO, JSON-LD structured data, and how a fast-loading pest control website converts 11pm emergency searches into booked jobs.',
    datePublished: '2026-07-16',
    dateModified: '2026-07-16',
    author: 'Iedrees Francis',
    category: 'Case Study',
  ...
  },
  {
    ...
    excerpt: 'A full technical and strategic breakdown of the Pixel Perfect Hair website project built by NextGenWebs — covering the visual-first design strategy for hair salons, the React and Vite stack, gallery and stylist profile architecture, booking conversion flow, mobile-first imperatives, local SEO for hair salons, and why premium salon brands need custom websites.',
    datePublished: '2026-07-16',
    dateModified: '2026-07-16',
    author: 'Iedrees Francis',
    category: 'Case Study / Beauty',
  ...
  {
    slug: 'plumbing-website-design-cape-town',
    title: 'Why Every Plumbing Business in Cape Town Needs a High-Converting Website',
    excerpt: 'Why Every Plumbing Business in Cape Town Needs a High-Converting Website',
    datePublished: '2026-07-16',
    dateModified: '2026-07-16',
    author: 'Iedrees Francis',
    category: 'Case Study / Service',
  ...
  },
  {
    ...
    title: '"Building a Premium Clinical Booking Portal for Advanced',
    excerpt: 'Blog post: "Building a Premium Clinical Booking Portal for Advanced Bioelectric Healing Technology: The RAVERSUS Story"',
    datePublished: '2026-07-16',
    dateModified: '2026-07-16',
    author: 'Iedrees Francis',
    category: 'Case Study',
  ...
  {
    slug: 'signage-business-website-design',
    title: 'Designing a Signage and Custom Fabrication Business Website That Shows Off Your Work and Wins Quotes',
    excerpt: 'Blog post covering the design and development of Aura Signs, a bold,',
    datePublished: '2026-07-16',
    dateModified: '2026-07-16',
    author: 'Iedrees Francis',
    category: 'Case Study / Creative',
  ...
  {
    slug: 'solar-lead-generation-website-template',
    title: '"How I Built a Solar Installer Lead Generation Website',
    excerpt: 'Blog post: "How I Built a Solar Installer Lead Generation Website Using AI-Assisted Development with Claude Code"',
    datePublished: '2026-07-16',
    dateModified: '2026-07-16',
    author: 'Iedrees Francis',
    category: 'Case Study',
  ...
  },
  {
    ...
    title: '"How to Build a Tiling Contractor Website That Qualifies',
    excerpt: 'Blog post: "How to Build a Tiling Contractor Website That Qualifies Leads Before They Call"',
    datePublished: '2026-07-16',
    dateModified: '2026-07-16',
    author: 'Iedrees Francis',
    category: 'Case Study',
  ...
  },
  {
    ...
    title: 'Building a Premium Commercial Service Website for a Window and Glazing Business',
    excerpt: 'Building a Premium Commercial Service Website for a Window and Glazing Business',
    datePublished: '2026-07-16',
    dateModified: '2026-07-16',
    author: 'Iedrees Francis',
    category: 'Case Study / Service',
  ...
  },
  {
    ...
    title: 'How to Build a Skincare Clinic Website That Books More Consultations',
    excerpt: 'How to Build a Skincare Clinic Website That Books More Consultations',
    datePublished: '2026-07-16',
    dateModified: '2026-07-16',
    author: 'Iedrees Francis',
    category: 'Case Study / Beauty',
...
export const articleContentMap: Record<string, ArticleContentComponent> = {
  ...
  'plumbing-website-design-cape-town': PlumbingWebsiteDesignCapeTownContent,
  'raversus-clinical-portal': RaversusClinicalPortalContent,
